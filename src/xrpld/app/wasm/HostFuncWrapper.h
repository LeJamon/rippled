...
using getDataNestedObjectField_proto = int32_t(
    uint8_t*,
    int32_t,
    uint8_t const*,
    int32_t,
...
using setDataNestedObjectField_proto = int32_t(
    uint8_t*,
    int32_t,
    uint8_t const*,
    int32_t,
...
using getDataArrayElementField_proto = int32_t(
    uint8_t*,
    int32_t,
    int32_t,
    uint8_t const*,
...
using setDataArrayElementField_proto = int32_t(
    uint8_t*,
    int32_t,
    int32_t,
    uint8_t const*,
